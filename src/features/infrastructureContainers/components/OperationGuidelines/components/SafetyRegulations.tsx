      ...
      <>
        <div className="text-sm text-gray-600 px-5">
          <ul className="flex flex-col gap-y-5 list-disc">
            <li>
              Visitors are prohibited from entering the port area without the permission
              of authorized STT personnel.
            </li>
            <li>
              Visitors are required to contact the Terminal Service (TMS) Office to obtain
              clothing that will ensure visibility.
            </li>
            <li>
              Visitors are required to comply with all PROHIBITED, MANDATORY and WARNING signs,
              and wear a safety helmet at all times.
            </li>
            <li>
              Visitors who enter the port area via the apron site and/or onboard a vessel are
              required to use the pedestrian walkways along the terminal fence and not take
              short-cuts through the container yard.
            </li>
            <li>
              Photography and video recording within the port area are prohibited without the
            ...
            <li>
              All vehicle drivers inside the port area are to comply with traffic and safety
              rules and are not to leave the vehicles without permission.
            </li>
            <li>
              Vehicles are not to be parked on equipment travel routes and operations areas.
            </li>
            <li>
              It is the responsibility of everyone to provide STT personnel with any
              information that may affect port security or be of significance to the port
              facility and shipping security as specified in the ISPS
            ...
            <li>
              ...
              <a href="mailto:sshe.stt@sahathai.com" className="text-black underline">
