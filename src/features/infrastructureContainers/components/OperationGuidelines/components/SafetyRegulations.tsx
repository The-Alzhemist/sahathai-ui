  ...
  return (
    <div className='text-sm text-gray-600 px-5'>
      <ul className='flex flex-col gap-y-5 list-disc mb-5'>
        ...
        <li>
          พาหนะทุกประเภทที่ขับขี่ในพื้นที่ตู้คอนเทนเนอร์ ต้องใช้ความเร็วไม่เกิน
          20 กม./ชม. ในวันทำการ
        </li>
        ...
        <li>หากมีการละเมิดระเบียบที่กำหนดจะถูกยกเลิกใบอนุญาตเรือขนส่งสินค้า</li>
      </ul>
    </div>
  )
}
  ...
  return (
    <div className='text-sm text-gray-600 px-5'>
      <ul className='flex flex-col gap-y-5 list-disc'>
        ...
        <li>
          Visitors are required to contact the Terminal Service (TMS) Office to
          obtain clothing that will ensure visibility.
        </li>
        <li>
        ...
        <li>
          ...
          vessel are required to use the pedestrian walkways along the terminal
          fence and not take short-cuts through the container yard.
        </li>
        <li>
        ...
        <li>
          ...
          and safety rules and are not to leave the vehicles without permission.
        </li>
        <li>
        ...
        <li>
          ...
          information that may affect port security or be of significance to the
          port facility and shipping security as specified in the ISPS
          (International Ship and Port Facility Security) Code.
        </li>
        <li>
          Violation of regulations will lead to the termination of the vessel’s
          access pass.
        </li>
      </ul>
    </div>
