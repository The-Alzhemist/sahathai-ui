      ...
      <>
          <div className='text-sm text-gray-600'>
              <ul className='flex flex-col gap-y-5 list-disc'>
                  <li className='text-gray-600 text-sm'>วกัปตันเรือ/หัวหน้าเจ้าหน้าที่มีหน้าที่รับผิดชอบในการตรวจสอบและตรวจสอบทรัพย์สินของสหไทย
                  ...
                  <li className='text-gray-600 text-sm'>สกัปตันเรือ/หัวหน้าเจ้าหน้าที่
