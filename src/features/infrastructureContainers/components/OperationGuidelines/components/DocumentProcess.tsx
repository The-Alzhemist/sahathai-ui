    ...
    <div className='px-5 text-sm text-gray-600'>
      ...
      <ul className='flex flex-col gap-y-5 list-disc mb-5'>
        <li>
          ...
          submit the EDI (Electronic Data Interchange) (Baplie)/CASP and Special
          Cargo lists to the STT Planner.
        </li>
        <li>
      ...
      <ul className='flex flex-col gap-y-5 list-disc'>
        ...
        <li>
          Not later than 12 hours prior to ETA, the shipping line or agent must
          submit the Final Loading List and Final Loading Summary to the STT
          Planner, in addition to the Final Loading Plan (if any).
        </li>
        <li>
          Soon after the CY (Container Yard) cutoff time, the shipping line or
          agent must confirm the Shut-Out Containers list with the STT Planner.
        </li>
        <li>
          In cases of full terminal booking, the shipping line or agent must
          submit to the STT Planner a waiting list of containers to avoid delays
          on shut-out decisions.
        </li>
      </ul>
    </div>
  )
