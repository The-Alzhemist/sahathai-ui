  ...
  return (
    <div className='text-sm text-gray-600 px-5'>
      <ul className='flex flex-col gap-y-5 list-disc mb-7'>
        ...
        <li>
          เมื่อสหไทย เทอร์มินอล ส่งมอบสินค้าในสภาพสมบูรณ์และครบถ้วนเรียบร้อยแล้ว
          สหไทย เทอร์มินอลจะไม่มีส่วนรับผิดชอบต่อความเสียหายใดๆ
  ...
  return (
    <div className='text-sm text-gray-600 px-5'>
      <ul className='flex flex-col gap-y-5 list-disc'>
        <li>
          In the event that cargo is damaged during stuffing and un-stuffing by
          STT, including during lifting onto the truck, and the damage has
        ...
        <li>
          ...
          then STT will not be liable in any case. Once STT has delivered cargo
          in full and satisfactory condition, STT will not be liable for any
          damages detected after the delivery.
        </li>
        <li>
