  ...
  return (
    <Animation className='max-w-[896px] mx-auto space-y-[32px] shadow-2 rounded-[8px] p-[24px] bg-white'>
      <PolicyCard
        ...
        downloadLink='https://a.storyblok.com/f/316761/x/75ef1ec657/security-policy-2561.pdf?cv=1757652967941'
      />
      <PolicyCard
        title={t('employeeCompensationPolicy')}
        downloadLink='https://a.storyblok.com/f/316761/x/d03e288856/salary-policy.pdf'
      />
      <PolicyCard
